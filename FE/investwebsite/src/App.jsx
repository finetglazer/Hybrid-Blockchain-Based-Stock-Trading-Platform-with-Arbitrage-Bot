      ...
      <AppContextProvider>
        <AppLayout>
          <Routes>
            ...
            <Route path="/deposit/choose-trading-account" element={<ChooseTradingAccount />} />
            <Route path="/withdraw/choose-trading-account" element={<ChooseTradingAccount />} />
            <Route path="/portfolio/choose-trading-account" element={<ChooseTradingAccount />} />
